...
public class TriangleTest {
  ...
  public void construct() {
    ...
    assertThat(t.normal()).isApproximatelyEqualTo(Tuple.vector(0, 0, -1));
  }
  ...
  public void normal() {
    ...
    Tuple p3 = Tuple.point(1, 0, 0);
    Triangle t = Triangle.createRaw(p1, p2, p3);
    assertThat(t.normalAt(Tuple.point(0, 0.5, 0))).isEqualTo(t.normal());
    assertThat(t.normalAt(Tuple.point(-0.5, 0.75, 0))).isEqualTo(t.normal());
    assertThat(t.normalAt(Tuple.point(0.5, 0.25, 0))).isEqualTo(t.normal());
  }
