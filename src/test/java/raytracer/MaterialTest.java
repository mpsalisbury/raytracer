...
public class MaterialTest {
  ...
  public void constructMaterial() {
    ...
    assertThat(m.pattern().colorAt(Tuple.createPoint(0, 0, 0))).isEqualTo(Color.WHITE);
  ...
  public void lightingEyeStraightLightStraight() {
    ...
    Tuple eyev = Tuple.createVector(0, 0, -1);
    Tuple normalv = Tuple.createVector(0, 0, -1);
    Light light = Light.create(Tuple.createPoint(0, 0, -10), Color.WHITE);
  ...
  public void lightingEye45LightStraight() {
    Material m = Material.create();
    Tuple position = Tuple.createPoint(0, 0, 0);
    Tuple eyev = Tuple.createVector(0, 1, -1).normalize();
    Tuple normalv = Tuple.createVector(0, 0, -1);
    Light light = Light.create(Tuple.createPoint(0, 0, -10), Color.WHITE);
    Color visibleLight = Color.WHITE;
    assertThat(m.lighting(light, position, eyev, normalv, visibleLight))
  ...
  public void lightingEyeStraightLight45() {
    ...
    Tuple eyev = Tuple.createVector(0, 0, -1);
    Tuple normalv = Tuple.createVector(0, 0, -1);
    Light light = Light.create(Tuple.createPoint(0, 10, -10), Color.WHITE);
    Color visibleLight = Color.WHITE;
    assertThat(m.lighting(light, position, eyev, normalv, visibleLight))
  ...
  public void lightingPattern() {
    ...
    Light light = Light.create(Tuple.createPoint(0, 0, -10), Color.WHITE);
    Color visibleLight = Color.WHITE;
    assertThat(m.lighting(light, Tuple.createPoint(0.9, 0, 0), eyev, normalv, visibleLight))
        .isEqualTo(Color.WHITE);
    assertThat(m.lighting(light, Tuple.createPoint(1.1, 0, 0), eyev, normalv, visibleLight))
